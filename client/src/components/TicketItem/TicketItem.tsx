...
export const ToogleGroup: FC = () => {
  ...
  <div> 
    <div className={styles["item"]}>
      <button className={styles[style_0]}
        onClick = {() => handleClick(types[0])}
      
      
      >{types[0]}</button>

      <button className={styles[style_1]}
        onClick = {() => handleClick(types[1])}
      
      
      >{types[1]}</button>

      <button className={styles[style_2]}
        onClick = {() => handleClick(types[2])}
      
      
      >{types[2]}</button>

      <button className={styles[style_3]}
        onClick = {() => handleClick(types[3])}
      
      
      >{types[3]}</button>

      <button className={styles[style_4]}
        onClick = {() => handleClick(types[4])}
      
      >{types[4]}</button>

      <button className={styles[style_5]}
